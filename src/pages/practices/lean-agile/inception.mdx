...
- Improve the quality of the code *(how do we know we have done it?)*
- Fly to Pluto *(unobtainable feature)*
...
on the groups you feel are the biggest risk - *limited to three dots each*)
4. discuss them
...
Finally, the stories are estimated. We usually do this using *story points*
on a *Fibonnaci scale*. That is to say, we estimate the work of a story
