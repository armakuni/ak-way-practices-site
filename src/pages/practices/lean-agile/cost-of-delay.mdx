...
> Total Value = (Increase Revenue * Increase Revenue Probability) + (Protect Revenue * Protect Revenue Probability) + (Reduce Revenue * Reduce Revenue Probability) + (Avoid Revenue * Avoid Revenue Probability)
...
*Credit: [Black Swan Farming: Urgency Profiles](http://blackswanfarming.com/urgency-profiles/)*
...
> Total Value = Increased Revenue * Increased Revenue Probability
> Total Value += Protected Revenue * Protected Revenue Probability
> Total Value += Reduced Costs * Reduced Revenue Probability
> Total Value += Avoided Costs * Avoided Revenue Probability
