...
- _**Definition of Ready**_: When a story has all the prerequisites to be worked on by a team. Our approach to this is having a short description of the intention of the current story (`As a X I want to do Y so that I can achieve Z.`), followed by an *Acceptance Criteria* defined as a GWT (GIVEN/WHEN/THEN) scenario (Gherkin style).
